  ...
  return (
    ...
    <div className="culture_container">
        <Navbar/>
            ...
            <img className = "runMan" id='gifRunMan1' src={runPeople} alt="runPeople" />
            <img className = "runMan" id='gifRunMan2' src={runPeople} alt="runPeople" />
            <img className = "runMan" id='gifRunMan3' src={runPeople} alt="runPeople" />
            <img className = "runMan" id='gifRunMan4' src={runPeople} alt="runPeople" />
        ...
        <div className="culture__item-video">
            <video className='item-video' id='item-video1' autoplay  controls playsinline>
                <source  src={Episode1} type="video/mp4"/>
            </video>
            <video className='item-video' id='item-video2' autoplay  controls playsinline>
                <source  src={Episode2} type="video/mp4"/>
            </video>
            <video className='item-video' id='item-video3' autoplay  controls playsinline>
                <source  src={Episode3} type="video/mp4"/>
            </video>
            <video id='item-video4' autoplay  controls playsinline>
                <source  src={Episode4} type="video/mp4"/>
            </video>
            <video className='item-video' id='item-video5' autoplay  controls playsinline>
