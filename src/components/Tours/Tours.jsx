...
<div className="adaptTours-filter">
    <div>
    <img className="adaprTrekking__item-tours" src={Trekking} alt='Trekking'/>
    <p  className='toursText'>Trekking Tours</p>
    </div>
   <div >
   <img className="adaptMultidays__item-tours" src={Multidays} alt='Multidays'/>
    <p className='toursText'>Multidays Tours</p>
   </div>
   <div >
   <img className="adaptHorse__item-tours" src={HorseBack} alt='HorseBack'/>
