...
import ProducFoodmainImg from "../assetsProducts/product-food.png"
  ...
  return (
    ...
    <div className="product__food_main-container">
        ...
        <div className="product__food_text">
           <h1 >Feel the Taste of 
Kyrgyz Traditional Food</h1>
<p>Indulge in the delectable flavors of Kyrgyz cuisine, a true feast for the senses. From the tender Beshbarmak to the savory Manty and the comforting Shorpo, Kyrgyz food offers a delightful blend of hearty meats, aromatic spices, and fresh herbs. Prepare to savor the rich cultural heritage and culinary traditions of this Central Asian gem with every bite.</p>
        </div>
